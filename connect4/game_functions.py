...
class RandomPlayer(Player):
    """can be used for an unintelligent computer player
    ...
    def next_move(self, b):
        """overrides (i.e., replaces) the next_move method that
           ...
           for the next move, this version of next_move  chooses at
           random from the columns in the board b that are not yet full,
